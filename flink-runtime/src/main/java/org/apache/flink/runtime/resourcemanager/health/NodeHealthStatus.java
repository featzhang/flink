...
/**
 * Represents the health status of a node (TaskManager).
 *
 * <p>This class contains information about whether a node is quarantined, the reason for
 * quarantine, and the timestamps for when quarantine started and when it expires.
 */
public class NodeHealthStatus {
     ...
     * @param quarantineTimestamp the timestamp when quarantine started
     * @param expirationTimestamp the timestamp when quarantine expires
     */
    ...
    /**
     * Get the timestamp when quarantine started.
     *
    ...
    /**
     * Get the timestamp when quarantine expires.
     *
     ...
     * @return true if quarantine has expired, false otherwise
     */
