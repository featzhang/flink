...
/**
 * Message headers for removing a node quarantine via REST API.
 *
 * <p>Provides a DELETE endpoint to remove a node from quarantine, allowing it to participate in
 * slot allocation again.
 */
public final class NodeQuarantineRemoveHeaders
    ...
    public static final String URL = "/cluster/nodes/:nodeId/quarantine";
    ...
    public NodeQuarantineMessageParameters getUnresolvedMessageParameters() {
        return new NodeQuarantineMessageParameters();
    }
    ...
    public String getDescription() {
        return "Remove a node from quarantine, allowing it to participate in slot allocation.";
    }
