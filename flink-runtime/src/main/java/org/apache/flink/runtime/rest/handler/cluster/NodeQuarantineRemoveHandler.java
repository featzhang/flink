...
/**
 * Handler for removing a node quarantine.
 *
 * <p>Handles DELETE requests to remove a node from quarantine, allowing it to participate in slot
 * allocation again.
 */
public class NodeQuarantineRemoveHandler
    ...
    public NodeQuarantineRemoveHandler(
            ...
            MessageHeaders<EmptyRequestBody, EmptyResponseBody, NodeQuarantineMessageParameters>
                    messageHeaders,
    ...
    protected CompletableFuture<EmptyResponseBody> handleRequest(
        ...
        // Call the ResourceManager to remove the quarantine
        return resourceManagerGateway
                .removeQuarantine(nodeId, timeout)
