...
/** Headers for the {@link NodeQuarantineHandler}. */
public final class NodeQuarantineHeaders
    ...
    public String getDescription() {
        return "Quarantine a node to prevent it from receiving new slot allocations.";
    }
